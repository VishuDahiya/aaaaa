...
import { getUserMessgeOneToOne, userMessage } from '../../redux/actions/exploreAction';
...
export default class Chat extends Component {
    ...
    getUserData = (commonConversationId) => {
        ...
        this.setState({ isLoading: true, commonConversationData: [] }, () => {
            getUserMessgeOneToOne(query).then(res => {
                this.props.navigation.navigate(navigationStrings.CHAT_DETAILS, { chats: res.data });
